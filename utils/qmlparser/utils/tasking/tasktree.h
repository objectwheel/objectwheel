...
class UTILS_EXPORT TaskInterface : public QObject
{
    Q_OBJECT
...
class UTILS_EXPORT TreeStorageBase
{
public:
    bool isValid() const;
...
class UTILS_EXPORT Group : public GroupItem
{
public:
...
UTILS_EXPORT GroupItem onGroupDone(const GroupItem::GroupEndHandler &handler);
UTILS_EXPORT GroupItem onGroupError(const GroupItem::GroupEndHandler &handler);
UTILS_EXPORT GroupItem parallelLimit(int limit);
UTILS_EXPORT GroupItem workflowPolicy(WorkflowPolicy policy);

UTILS_EXPORT extern const GroupItem sequential;
UTILS_EXPORT extern const GroupItem parallel;

UTILS_EXPORT extern const GroupItem stopOnError;
UTILS_EXPORT extern const GroupItem continueOnError;
UTILS_EXPORT extern const GroupItem stopOnDone;
UTILS_EXPORT extern const GroupItem continueOnDone;
UTILS_EXPORT extern const GroupItem stopOnFinished;
UTILS_EXPORT extern const GroupItem finishAllAndDone;
UTILS_EXPORT extern const GroupItem finishAllAndError;

class UTILS_EXPORT Storage : public GroupItem
{
public:
...
class UTILS_EXPORT Sync : public Group
{
...
class UTILS_EXPORT TaskTree final : public QObject
{
    Q_OBJECT
...
class UTILS_EXPORT TaskTreeTaskAdapter : public TaskAdapter<TaskTree>
{
public:
    TaskTreeTaskAdapter();
    void start() final;
...
class UTILS_EXPORT TimeoutTaskAdapter : public TaskAdapter<std::chrono::milliseconds>
{
public:
    TimeoutTaskAdapter();
    ~TimeoutTaskAdapter();
