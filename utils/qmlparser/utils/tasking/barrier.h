...
class UTILS_EXPORT Barrier final : public QObject
{
    Q_OBJECT
...
class UTILS_EXPORT BarrierTaskAdapter : public TaskAdapter<Barrier>
{
public:
...
class UTILS_EXPORT WaitForBarrierTask : public BarrierTask
{
public:
    template <int Limit>
