...
QTCREATOR_UTILS_EXPORT extern const Icon DESIGNS_TOOLBAR;
QTCREATOR_UTILS_EXPORT extern const Icon OTHERS_TOOLBAR;
QTCREATOR_UTILS_EXPORT extern const Icon ASSETS_TOOLBAR;
