...
{
    return QIcon("Utils::CodeModelIcon::iconForType(Utils::CodeModelIcon::Class)");
}

QIcon Icons::scriptBindingIcon()
{
    return QIcon("Utils::CodeModelIcon::iconForType(Utils::CodeModelIcon::VarPublic)");
}

QIcon Icons::publicMemberIcon()
{
    return QIcon("Utils::CodeModelIcon::iconForType(Utils::CodeModelIcon::FuncPublic)");
}
