...
void FakeMetaEnum::addToHash(QCryptographicHash &hash) const
{
    ...
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(m_name.constData()), len * sizeof(QChar)));
    len = m_keys.size();
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    for (const QString &key : std::as_const(m_keys)) {
        len = key.size();
        hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
        hash.addData(QByteArrayView(reinterpret_cast<const char *>(key.constData()), len * sizeof(QChar)));
    }
}
...
void FakeMetaMethod::addToHash(QCryptographicHash &hash) const
{
    ...
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(m_name.constData()), len * sizeof(QChar)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&m_methodAccess), sizeof(m_methodAccess)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&m_methodTy), sizeof(m_methodTy)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&m_revision), sizeof(m_revision)));
    len = m_paramNames.size();
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    for (const QString &pName : std::as_const(m_paramNames)) {
        len = pName.size();
        hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
        hash.addData(QByteArrayView(reinterpret_cast<const char *>(pName.constData()), len * sizeof(QChar)));
    }
    ...
    for (const QString &pType : std::as_const(m_paramTypes)) {
        len = pType.size();
        hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
        hash.addData(QByteArrayView(reinterpret_cast<const char *>(pType.constData()), len * sizeof(QChar)));
    }
    len = m_returnType.size();
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(m_returnType.constData()), len * sizeof(QChar)));
}
...
void FakeMetaProperty::addToHash(QCryptographicHash &hash) const
{
    ...
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(m_propertyName.constData()), len * sizeof(QChar)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&m_revision), sizeof(m_revision)));
    int flags = (m_isList ? (1 << 0) : 0)
            + (m_isPointer ? (1 << 1) : 0)
            + (m_isWritable ? (1 << 2) : 0);
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&flags), sizeof(flags)));
    len = m_type.size();
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(m_type.constData()), len * sizeof(QChar)));
}
...
QByteArray FakeMetaObject::calculateFingerprint() const
{
    ...
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(m_className.constData()), len * sizeof(QChar)));
    len = m_attachedTypeName.size();
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(m_attachedTypeName.constData()), len * sizeof(QChar)));
    len = m_defaultPropertyName.size();
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(m_defaultPropertyName.constData()), len * sizeof(QChar)));
    ...
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    {
        ...
        for (const QString &key : std::as_const(keys)) {
            ...
            hash.addData(QByteArrayView(reinterpret_cast<const char *>(&value), sizeof(value))); // avoid? this adds order dependency to fingerprint...
    ...
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(m_superName.constData()), len * sizeof(QChar)));
...
void FakeMetaObject::Export::addToHash(QCryptographicHash &hash) const
{
    ...
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(package.constData()), len * sizeof(QChar)));
    len = type.size();
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&len), sizeof(len)));
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(type.constData()), len * sizeof(QChar)));
    version.addToHash(hash);
    hash.addData(QByteArrayView(reinterpret_cast<const char *>(&metaObjectRevision), sizeof(metaObjectRevision)));
}
