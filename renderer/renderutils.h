...
public:
    ...
    static QList<QString> events(const RenderEngine::ControlInstance* instance);
    static QList<PropertyNode> properties(const RenderEngine::ControlInstance* instance);
