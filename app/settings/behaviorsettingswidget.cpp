  ...
  , m_colorSchemeEdit(new TextEditor::Internal::ColorSchemeEdit(m_colorSchemeGroup))
{
    ...
    connect(m_colorSchemeBox, qOverload<int>(&QComboBox::currentIndexChanged),
            this, &BehaviorSettingsWidget::onColorOptionsChange);
    connect(m_fontFamilyBox, &QComboBox::currentTextChanged,
            this, &BehaviorSettingsWidget::onFontOptionsChange);
    ...
    connect(m_fontResetButton, &QPushButton::clicked,
            this, &BehaviorSettingsWidget::onFontResetButtonClick);
    connect(m_colorSchemeCopyButton, &QPushButton::clicked,
            this, &BehaviorSettingsWidget::onColorSchemeCopyButtonClick);
    connect(m_colorSchemeDeleteButton, &QPushButton::clicked,
            this, &BehaviorSettingsWidget::onColorSchemeDeleteButtonClick);
...
void BehaviorSettingsWidget::onFontOptionsChange()
{
...
void BehaviorSettingsWidget::onColorOptionsChange(int index)
{
...
void BehaviorSettingsWidget::onFontResetButtonClick()
{
    const BehaviorSettings settings;
    m_fontFamilyBox->setCurrentText(settings.fontFamily);
    m_fontSizeBox->setCurrentText(QString::number(settings.fontPixelSize));
    m_fontThickBox->setChecked(settings.fontPreferThick);
    m_fontAntialiasingBox->setChecked(settings.fontPreferAntialiasing);
...
void BehaviorSettingsWidget::onColorSchemeCopyButtonClick()
{
...
void BehaviorSettingsWidget::onColorSchemeDeleteButtonClick()
{
...
void BehaviorSettingsWidget::maybeSaveColorScheme(const QString& fileName)
{
    if (g_disableSaving)
        return;
...
void BehaviorSettingsWidget::setCurrentColorScheme(const QString& fileName)
{
