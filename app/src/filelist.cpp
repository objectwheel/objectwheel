...
void FileList::resizeEvent(QResizeEvent* event)
{
    ...
    dbs->ra = dbs->r.adjusted(fit(25), fit(17), -fit(25), -fit(33));
    ...
    painter.drawRoundedRect(dbs->r, fit(12), fit(12));
    ...
    painter.drawText(dbs->r.adjusted(0, fit(10), 0, -fit(10)), "Drop Here",
