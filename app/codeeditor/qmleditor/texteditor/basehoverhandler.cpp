...
void BaseHoverHandler::showToolTip(QmlCodeEditor *widget, const QPoint &point, bool decorate)
{
    if (decorate)
        decorateToolTip();
...
void BaseHoverHandler::checkPriority(QmlCodeEditor *widget,
                                     int pos,
...
//void BaseHoverHandler::contextHelpId(QmlCodeEditor *widget,
//                                     int pos,
...
//void BaseHoverHandler::propagateHelpId(QmlCodeEditor *widget,
//                                       const Core::IContext::HelpIdCallback &callback)
//{
//    QString id;
//    if (lastHelpItemIdentified().isValid())
...
void BaseHoverHandler::process(QmlCodeEditor *widget, int pos, ReportPriority report)
{
    m_toolTip.clear();
    m_priority = -1;
...
void BaseHoverHandler::identifyMatch(QmlCodeEditor *editorWidget, int pos, ReportPriority report)
{
...
void BaseHoverHandler::operateTooltip(QmlCodeEditor *editorWidget, const QPoint &point)
{
