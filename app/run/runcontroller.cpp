...
RunController::RunController(QWidget *parent) : QToolBar(parent)
  ...
  , m_runProgressBar(new RunProgressBar)
{
    ...
    connect(m_runButton, &PushButton::clicked, this, &RunController::runButtonClicked);
    connect(m_runButton, &PushButton::clicked, this, &RunController::onRunButtonClick);
    ...
    connect(m_preferencesButton, &PushButton::clicked, this, &RunController::preferencesButtonClicked);
    ...
    connect(m_projectsButton, &PushButton::clicked, this, &RunController::projectsButtonClicked);
    ...
    connect(GeneralSettings::instance(), &GeneralSettings::interfaceSettingsChanged,
            this, qOverload<>(&RunController::update));
}
...
void RunController::paintEvent(QPaintEvent*)
{
...
QSize RunController::minimumSizeHint() const
{
    return QSize(0, 38);
}

QSize RunController::sizeHint() const
{
    return QSize(100, 38);
}
