...
//    void contextHelpId(QmlCodeEditor *widget,
//                       int pos,
//                       const Core::IContext::HelpIdCallback &callback);

    using ReportPriority = std::function<void(int priority)>;
    void checkPriority(QmlCodeEditor *widget, int pos, ReportPriority report);
    virtual void abort() {} // Implement for asynchronous priority reporter

    void showToolTip(QmlCodeEditor *widget, const QPoint &point, bool decorate = true);
...
//    void propagateHelpId(QmlCodeEditor *widget, const Core::IContext::HelpIdCallback &callback);
    ...
    virtual void identifyMatch(QmlCodeEditor *editorWidget, int pos, ReportPriority report);
    virtual void decorateToolTip();
    virtual void operateTooltip(QmlCodeEditor *editorWidget, const QPoint &point);

private:
    void process(QmlCodeEditor *widget, int pos, ReportPriority report);
