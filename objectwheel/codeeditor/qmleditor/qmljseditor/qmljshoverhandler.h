...
private:
    ...
    void identifyMatch(QmlCodeEditor *editorWidget,
                       int pos,
                       ReportPriority report) override;
    void operateTooltip(QmlCodeEditor *editorWidget, const QPoint &point) override;

    bool matchDiagnosticMessage(QmlCodeEditor *qmlEditor, int pos);
