...
UpdateSettingsWidget::UpdateSettingsWidget(QWidget* parent) : SettingsWidget(parent)
  ...
  , m_themeLabel(new QLabel(m_updateGroup))
  , m_languageLabel(new QLabel(m_updateGroup))
  , m_hdpiLabel(new QLabel(m_updateGroup))
  , m_highlightColorLabel(new QLabel(m_updateGroup))
  , m_themeBox(new QComboBox(m_updateGroup))
  , m_languageBox(new QComboBox(m_updateGroup))
  , m_hdpiCheckBox(new QCheckBox(m_updateGroup))
  , m_highlightColorButton(new Utils::QtColorButton(m_updateGroup))
  , m_highlightColorResetButton(new QPushButton(m_updateGroup))
  /****/
  ...
  , m_designerStateResetButton(new QPushButton(m_behavioralGroup))
{
    ...
    updateLayout->addWidget(m_themeLabel, 0, 0, Qt::AlignLeft | Qt::AlignVCenter);
    updateLayout->addWidget(m_languageLabel, 1, 0, Qt::AlignLeft | Qt::AlignVCenter);
    updateLayout->addWidget(m_hdpiLabel, 2, 0, Qt::AlignLeft | Qt::AlignVCenter);
    updateLayout->addWidget(m_highlightColorLabel, 3, 0, Qt::AlignLeft | Qt::AlignVCenter);
    updateLayout->addWidget(m_themeBox, 0, 2, Qt::AlignLeft | Qt::AlignVCenter);
    updateLayout->addWidget(m_languageBox, 1, 2, Qt::AlignLeft | Qt::AlignVCenter);
    updateLayout->addWidget(m_hdpiCheckBox, 2, 2, Qt::AlignLeft | Qt::AlignVCenter);
    updateLayout->addWidget(m_highlightColorButton, 3, 2, Qt::AlignLeft | Qt::AlignVCenter);
    updateLayout->addWidget(m_highlightColorResetButton, 3, 2, Qt::AlignRight | Qt::AlignVCenter);
    updateLayout->setColumnStretch(3, 1);
    updateLayout->setColumnMinimumWidth(1, 20);

    m_updateGroup->setTitle(tr("User Interface"));
    ...
    connect(m_highlightColorResetButton, &QPushButton::clicked, this, [=] {
        m_highlightColorButton->setColor(UpdateSettings(0).highlightColor);
    });
    connect(m_fontResetButton, &QPushButton::clicked, this, [=] {
        const UpdateSettings settings(0);
