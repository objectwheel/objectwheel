    ...
    , removeButton(new FlatButton)
{
    ...
    formsListWidget->setIconSize(QSize(fit::fx(14),fit::fx(14)));
    ...
    verticalLayout->setSpacing(fit::fx(2));
    verticalLayout->setContentsMargins(fit::fx(3), fit::fx(3), fit::fx(3), fit::fx(3));
...
{
    return QSize(fit::fx(200), fit::fx(10));
}
